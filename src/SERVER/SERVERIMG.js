...
document.getElementById('FilePublicacion').addEventListener('change', function(event) {
...
document.getElementById('PublicarPublicacion').addEventListener('click', async function() {
